<template>
  <form @submit.prevent="handleSubmit(!v$.$invalid)" class="p-fluid p-formgrid p-grid">
    ...
    <div v-if="!existingBrand && existingNation" class="p-field col-10">
    ...
    <div v-if="!existingBrand && !existingNation" class="p-field col-5 p-pr-1">
    ...
    <div v-if="!existingBrand && !existingNation" class="p-field col-5 p-pl-1">
    ...
    <div v-if="!existingBrand" class="p-field-checkbox col-2 p-pl-5 p-pt-5">
    ...
    <div v-if="existingAuthor" class="p-field col-10">
    ...
    <div v-if="!existingAuthor" class="p-field col-5 p-pr-1">
    ...
    <div v-if="!existingAuthor" class="p-field col-5 p-pl-1">
